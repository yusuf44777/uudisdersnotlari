const notes = [
  ...
  },
  {
    ...
    subtitle: "Diş hekimliği morfolojisinde temel terimler, yönler, yüzeyler ve final için başlangıç kavramları",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/01_Temel_Kavramlar_Calisma_Rehberi.html",
    tags: ["temel kavramlar", "morfoloji", "terminoloji"],
  },
  {
    id: "morphology-02a",
    course: "Dental Morphology",
    grade: "1. Sınıf",
    unit: "Batch 2A",
    title: "Diş Anatomisi - Ön Dişler",
    subtitle: "Genel ilkeler, kesici dişler, kaninler ve anterior diş anatomisi",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/02A_Dis_Anatomisi_On_Disler.html",
    tags: ["ön dişler", "kanin", "kesici"],
  },
  {
    id: "morphology-02b",
    course: "Dental Morphology",
    grade: "1. Sınıf",
    unit: "Batch 2B",
    title: "Diş Anatomisi - Arka Dişler",
    subtitle: "Premolar ve molar dişlerin morfolojik özellikleri, tüberküller ve oklüzal yüzeyler",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/02B_Dis_Anatomisi_Arka_Disler.html",
    tags: ["arka dişler", "premolar", "molar"],
  },
  {
    id: "morphology-03",
    course: "Dental Morphology",
    grade: "1. Sınıf",
    unit: "Batch 3",
    title: "Oklüzyon & Artikülatör",
    subtitle: "Oklüzyon kavramları, artikülatör kullanımı ve diş ilişkileri",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/03_Okluzyon_ve_Artikulator.html",
    tags: ["oklüzyon", "artikülatör", "diş ilişkileri"],
  },
  {
    id: "morphology-04a",
    course: "Dental Morphology",
    grade: "1. Sınıf",
    unit: "Batch 4A",
    title: "Total Protez - Destek Dokular & Ölçü",
    subtitle: "Total protezde destek dokular, ölçü prensipleri ve klinik hazırlık noktaları",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/04A_Total_Protez_Destek_Dokular_ve_Olcu.html",
    tags: ["total protez", "ölçü", "destek dokular"],
  },
  {
    id: "morphology-04b",
    course: "Dental Morphology",
    grade: "1. Sınıf",
    unit: "Batch 4B",
    title: "Custom Tray, Base Plate, Wax Rim & Diş Dizimi",
    subtitle: "Tray, base plate, wax rim ve total protez diş dizimi için çalışma rehberi",
    path: "1.%20S%C4%B1n%C4%B1f/Dental%20Morphology/04B_Total_Protez_Tray_BasePlate_WaxRim_DisDizimi.html",
  ...
  },
  {
    ...
    grade: "1. Sınıf",
    unit: "MDS 112",
    title: "Biyofizik Ders Notları: Membran & Asit-Baz",
    subtitle: "Hücre membranları, transport mekanizmaları, asit-baz bozuklukları ve kan gazları",
    path: "1.%20S%C4%B1n%C4%B1f/Biopyhsics/biyofizik_ders_notlari.html",
    tags: ["membran", "transport", "asit-baz"],
  },
  {
    id: "biophysics-02",
    course: "Biophysics",
    grade: "1. Sınıf",
    unit: "Final",
    title: "Biyofizik Final Çözümlü Çalışma Rehberi",
    subtitle: "Group A / Booklet A için 29 soru, doğru cevap gerekçeleri, çeldirici analizi ve hızlı tekrar",
    path: "1.%20S%C4%B1n%C4%B1f/Biopyhsics/s%C4%B1nav.html",
    tags: ["final", "çözümlü", "Group A"],
  },
  {
    id: "biochemistry-01",
    course: "Biochemistry",
  ...
  },
  {
    ...
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Genel Biyokimya",
    title: "Maddelerin Vücuttaki Akıbeti",
    subtitle: "Biyomoleküllerin yapısı, sindirimi, emilimi, taşınması ve vücuttaki temel kullanım yolları",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Maddelerin_Vucuttaki_Akibeti_Calisma_Rehberi.html",
    tags: ["biyomolekül", "emilim", "metabolizma"],
  },
  {
    id: "biochemistry-05",
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Metabolizma",
    title: "Lipid / Yağ Asidi Oksidasyonu (β-Oxidation)",
    subtitle: "Yağ asidi aktivasyonu, karnitin taşıması, beta oksidasyon, keton cisimleri ve enerji verimi",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Lipid_Oksidasyonu_Calisma_Rehberi.html",
    tags: ["lipid", "beta oksidasyon", "keton"],
  },
  {
    id: "biochemistry-06",
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Metabolizma",
    title: "Amino Asit Metabolizması & Üre Döngüsü",
    subtitle: "Transaminasyon, oksidatif deaminasyon, üre döngüsü ve amino asit metabolizması bozuklukları",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Amino_Asit_Metabolizmasi_Calisma_Rehberi.html",
    tags: ["amino asit", "üre döngüsü", "transaminasyon"],
  },
  {
    id: "biochemistry-07",
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Endokrin",
    title: "Pankreas - Endokrin & Ekzokrin İşlev",
    subtitle: "Pankreas hormonları, Langerhans adacıkları, sindirim enzimleri, insülin-glukagon dengesi ve diyabet",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Pankreas_Calisma_Rehberi.html",
  ...
  },
  {
    ...
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Mineral Metabolizması",
    title: "Kalsiyum & Fosfat Metabolizması",
    subtitle: "Kalsiyum-fosfat dengesi, PTH, vitamin D, kalsitonin, kemik/diş mineralizasyonu ve klinik bozukluklar",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Kalsiyum_Fosfat_Metabolizmasi_Calisma_Rehberi.html",
    tags: ["kalsiyum", "fosfat", "vitamin D"],
  },
  {
    id: "biochemistry-09",
    course: "Biochemistry",
    grade: "1. Sınıf",
    unit: "Kemik Metabolizması",
    title: "Kemik Metabolizması Biyokimyası",
    subtitle: "Kemik matriksi, osteoblast-osteoklast dengesi, RANKL ekseni, remodeling ve dental klinik bağlantılar",
    path: "1.%20S%C4%B1n%C4%B1f/Biochemistry/Kemik_Metabolizmasi_Calisma_Rehberi.html",
    tags: ["kemik", "osteoblast", "RANKL"],
  },
  {
    id: "embryology-01",
    course: "Embryology",
    ...
    unit: "Kaynak 1",
    title: "Gametogenesis",
    subtitle: "Oogenesis, spermatogenesis, meiosis, ovulasyon regülasyonu, corpus luteum ve spermatozoon yapısı",
    path: "1.%20S%C4%B1n%C4%B1f/Embriyology/01_Gametogenesis_Calisma_Rehberi.html",
    tags: ["gametogenesis", "oogenesis", "spermatogenesis"],
  },
  {
    id: "embryology-02",
    course: "Embryology",
    grade: "1. Sınıf",
    unit: "Kaynak 2",
    title: "Fertilization & First Week of Life",
    subtitle: "Döllenme, kapasitasyon, akrozom reaksiyonu, cleavage, morula, blastokist ve implantasyon",
    path: "1.%20S%C4%B1n%C4%B1f/Embriyology/02_Fertilization_1stWeek_Calisma_Rehberi.html",
    tags: ["fertilization", "blastokist", "implantasyon"],
  },
  {
    id: "embryology-03",
    course: "Embryology",
    grade: "1. Sınıf",
    unit: "Kaynak 3",
    title: "2nd & 3rd Week of Development",
    subtitle: "Bilaminar ve trilaminar disk, gastrülasyon, notokord, trofoblast gelişimi ve villus tipleri",
    path: "1.%20S%C4%B1n%C4%B1f/Embriyology/03_2nd_3rd_Week_Calisma_Rehberi.html",
    tags: ["gastrülasyon", "notokord", "trofoblast"],
  },
  {
    id: "embryology-04",
    course: "Embryology",
    grade: "1. Sınıf",
    unit: "Kaynak 4",
    title: "3rd-8th Week & Fetal Period",
    subtitle: "Organogenez, germ tabakası türevleri, nörülasyon, somitler, fetal dönem ve prenatal tanı",
  ...
  },
  {
    ...
    path: "1.%20S%C4%B1n%C4%B1f/Atat%C3%BCrk%20%C4%B0lkeleri%20ve%20%C4%B0nk%C4%B1lap%20Tarihi/inkilap_tarihi_final_rehberi.html",
  ...
  },
  {
    ...
    grade: "1. Sınıf",
    unit: "Komite 1",
    title: "Committee 1 - Çıkmış Sınav Zenginleştirilmiş Çalışma Rehberi",
    subtitle: "Genetik, anatomi, biyofizik, histoloji/embriyoloji ve biyokimya soruları için spot bilgi, klinik not ve flashcard destekli tekrar",
    path: "1.%20S%C4%B1n%C4%B1f/Komite%20%C3%87%C4%B1km%C4%B1%C5%9F/komite_1.html",
    tags: ["çıkmış sınav", "Komite 1", "flashcard"],
  },
  {
    id: "committee-02",
    course: "Komite Çıkmış",
    grade: "1. Sınıf",
    unit: "Komite 2",
    title: "Committee 2 - Çıkmış Sınav Zenginleştirilmiş Çalışma Rehberi",
    subtitle: "Anatomi, biyofizik, histoloji/embriyoloji ve biyokimya soruları için spot bilgi, klinik not ve flashcard destekli tekrar",
    path: "1.%20S%C4%B1n%C4%B1f/Komite%20%C3%87%C4%B1km%C4%B1%C5%9F/komite_2.html",
    tags: ["çıkmış sınav", "Komite 2", "flashcard"],
  },
];
